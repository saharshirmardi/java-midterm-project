    ...
    public static void main(String[] args) {
        ...
        while(!(tmp.equals("###"))) {
            ...
            if (!(tmp.equals("##"))) {
                ...
                List.ans.add("+++");
                for(int i=0 ; i<List.nodes.size();i++){
                    List.nodes.get(i).mand_child.removeAll(List.nodes.get(i).mand_child);
                    List.nodes.get(i).opt_child.removeAll(List.nodes.get(i).opt_child);
                    List.nodes.get(i).or_child.removeAll(List.nodes.get(i).or_child);
                    List.nodes.get(i).xor_child.removeAll(List.nodes.get(i).xor_child);
                }
